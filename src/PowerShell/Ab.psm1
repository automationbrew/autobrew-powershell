...
function Test-DotNet
{
    try
    {
        ...
        {
            throw ".NET Framework versions lower than 4.7.2 are not supported by the AutomationBrew PowerShell module. Please upgrade to .NET Framework 4.7.2 or higher."
        }
    }
...
if ($true -and ($PSEdition -eq 'Desktop'))
{
    ...
    {
        throw "PowerShell versions lower than 5.1 are not supported by the AutomationBrew PowerShell module. Please upgrade to PowerShell 5.1 or higher."
    }
