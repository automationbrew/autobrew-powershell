namespace AutoBrew.PowerShell.Runtime
{
    ...
    public class AsyncCommandRuntime : ICommandRuntime2, IDisposable
    {
        ...
        /// </summary>
        private readonly CancellationToken sourceCancellationToken;
        ...
        /// <summary>
        /// The handler for events that are generated by Microsoft Azure SDKs.
        /// </summary>
        private readonly AzureEventSourceListener eventListener;

        /// <summary>
        /// The cmdlet that is being invoked.
        /// </summary>
        private readonly PSCmdlet invokedCmdlet;
        ...
        /// <summary>
        /// The queue used by the command trace interceptor to capture debug message that should be displayed on the console.
        /// </summary>
        ...
        /// <summary>
        /// The interceptor used to trace operations performed by commands for debugging and informational purposes.
        /// </summary>
        private readonly CommandTracingInterceptor tracingInterceptor = new(messageQueue);
        ...
        /// </summary>
        public PSTransactionContext CurrentPSTransaction => invokedCmdlet.CommandRuntime.CurrentPSTransaction;

        /// <summary>
        /// Gets the instance of the <see cref="PSHost" /> class for this environment.
        /// </summary>
        public PSHost Host => invokedCmdlet.CommandRuntime.Host;
        ...
        public AsyncCommandRuntime(PSCmdlet cmdlet, CancellationToken cancellationToken)
        {
            ...
            eventListener = new AzureEventSourceListener((args, message) => messageQueue.Enqueue(message), EventLevel.Informational);
            commandRuntime = cmdlet.CommandRuntime as ICommandRuntime2;
            invokedCmdlet = cmdlet;
        ...
        protected virtual void Dispose(bool disposing)
        {
            ...
            if (disposing)
            {
                if (invokedCmdlet != null)
                {
                    invokedCmdlet.CommandRuntime = commandRuntime;
                }
        ...
        /// <summary>
        /// Processes the contents of the message queue.
        /// </summary>
        private void ProcessMessageQueue()
        {
            while (messageQueue.TryDequeue(out string message))
            {
                commandRuntime.WriteDebug(message);
            }
        }
        ...
        {
            WaitHandle.WaitAny(new[] { sourceCancellationToken.WaitHandle, invokeDone?.WaitHandle });
            semaphore?.Release();
        }
        ...
        {
            semaphore?.Wait(sourceCancellationToken);
            invokeDone.Reset();
        }
    }
}