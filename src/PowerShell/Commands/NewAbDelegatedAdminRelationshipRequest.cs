namespace AutoBrew.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "AbDelegatedAdminRelationshipRequest", SupportsShouldProcess = true)]
    ...
    public class NewAbDelegatedAdminRelationshipRequest : ModuleAsyncCmdlet
    {
        ...
        {
            await ConfirmActionAsync(Resources.NewDelegatedAdminRelationshipRequestAction, RelationshipId, async () =>
            {
